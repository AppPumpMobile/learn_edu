          ...
          return Positioned(
              child: Center(
                child: Container(
                  ...
                  margin: EdgeInsets.symmetric(vertical: 50,horizontal: MediaQuery.of(context).size.width*0.2),
                  child: Text(
                    "${widget.user.email}",
                    style: TextStyle(
                        color: Colors.black
          ...
          children: [
            ...
            StatefulBuilder(builder: (innerContext,update){
              ...
              return Positioned(
                  child: Center(
                    child: Container(
                      alignment: Provider.of<PlayerNotifier>(context).waterMark ? Alignment.topRight:Alignment.bottomLeft,
                      margin: EdgeInsets.symmetric(vertical: 50,horizontal: MediaQuery.of(context).size.width*0.2),
                      child: Text(
                        "${widget.user.email}",
                        style: TextStyle(
...
class ChewieController extends ChangeNotifier {
  ...
  /// Buttons
  ///
  /// These are  for the default `OptionItem`'s
