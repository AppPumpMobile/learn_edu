...
import 'chewie_package/src/chewie_player.dart';
import 'chewie_package/src/cupertino/cupertino_controls.dart';
...
class _PlayListScreenState extends State<PlayListScreen>
          ...
          onTap: () async{
            if (videoPlayerController != null){
              ...
              if (downloadBtnTxt == 'Delete Download' &&
                ...
                // } else
                if (lessClip.parent.split(".").last == 'wav' ||
              ...
              //   content: Text("Please wait before press to another lesson"),
              // ));
  ...
  onlineVideoPlayer(String url, {bool isIframe = false}) async {
    ...
    var checkUrl = url.split(".").last;
      ...
      // if (videoPlayerController != null && videoPlayerController.value.isInitialized && chewieController != null) {
      //   if (videoPlayerController.value.isPlaying && chewieController.isPlaying) {
      //     await videoPlayerController.pause();
      //     chewieController.pause();
      //   }
      //   //Do clear Cache here
      ...
      // if (videoPlayerController != null && videoPlayerController.value.isPlaying) await videoPlayerController.pause();
      ...
      if (videoPlayerController == null && chewieController == null) {
        print("i am in onlineVideoPlayer");
        ...
        print("i am in onlineVideoPlayer else");
  ...
  offlineVideoPlayer({String videoFile}) async{
    setState(() {
      urlType = "CUSTOM";
    });
    ...
    if (videoPlayerController != null) await videoPlayerController.dispose();
        ...
        body: DefaultTabController(
          ...
          child: NestedScrollView(
            headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
              print("i am in ${MediaQuery.of(context).orientation}");
              return <Widget>[
                SliverAppBar(
                        ...
                        if (urlType == "CUSTOM")
                          Container(
                            ...
                            child: videoPlayerController != null &&
                                ...
                                ? Stack(children: [
                              Chewie(controller: chewieController,user: user,),
                              ...
                              //   alignment: !waterMark ? Alignment.topCenter:Alignment.bottomCenter,
                              //   child: Text(
                              //     "${user.email}",
                              //     style: TextStyle(
