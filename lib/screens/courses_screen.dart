        ...
        children: <Widget>[
          ...
          Expanded(
            child: InkWell(
              onTap: () {
                setState(() {
                  _selectedIndex = 0;/// it should be 1 but now 0 because it is the only one
                });
                _pageController.animateToPage(0, /// it should be 1 but now 0 because it is the only one
                    duration: Duration(milliseconds: 500), curve: Curves.ease);
              },
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                ...
                children: <Widget>[
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.w700,
                      color: _selectedIndex == 0 /// it should be 1 but now 0 because it is the only one
                          ? Color(0xFF3f4654)
                          : Color.fromRGBO(180, 186, 198, 1.0),
                    ),
                  )
          ...
          child: Center(
            child: Column(
              children: <Widget>[
                ...
                getCourses(/*allCourses,wishcourses*/stud),
              ],
            ),
          ),
        ),
