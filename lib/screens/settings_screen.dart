          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Text("Technical Partner:",style: TextStyle(
                        color: Colors.black,
                        fontSize: 18,
                        fontWeight: FontWeight.w700)),
                    SizedBox(height: 10),
                    ClipRRect(
                      child: Image.asset("assets/app_pump.png",height: 30,),
                    ),
                    SizedBox(height: 15),
                    Row(
                      ...
                      children: [
                        InkWell(
                          onTap: () async{
                            await launchUrl(Uri.parse("tel:+201067866148"));
                          },
                        ...
                        InkWell(
                          onTap: () async{
                            await launchUrl(Uri.parse("https://www.facebook.com/AppPumpDev"));
                          },
