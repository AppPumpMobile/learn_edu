      ...
      onTap: () async {
        if (idx == 0) {
          ...
          if (_allClips != null && _allClips.length > 0) {
            ...
            print("this is pefore going to PlayListScreen where idx == 0");
          ...
          if (_allClips != null && _allClips.length > 0) {
            ...
            print("this is pefore going to PlayListScreen where idx == 1");
          ...
          Share.share(
            'https://play.google.com/store/apps/details?id=com.developer.learnacadmy',
